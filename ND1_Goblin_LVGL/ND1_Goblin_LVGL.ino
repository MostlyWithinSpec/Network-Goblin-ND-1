 ...
 *  "Here be packets."
 * ------------------------------------------------------------
 *  Serial commands: id | link | cable | tdr | pairs
 *                   | ping <host> | trace <host> | help
 * ============================================================ */
#include "ng_config.h"
#include "ng_eth.h"
#include "ng_tdr.h"
...
static void serialCmd(){
  ...
  while(Serial.available()){
    ...
    if(c=='\n'||c=='\r'){ buf[n]=0;
      ...
      else if(!strcmp(buf,"help")){ Serial.println("cmds: id | link | cable | tdr | pairs | ping <host> | trace <host> | help"); }
